...
public class ListarAlimentacion extends JDialog {
	 ...
	 */
	public ListarAlimentacion(Gestor gestor) {
		setTitle("Listar alimentacion");
		setResizable(false);
		inicializarGraficos();
		for (Producto productos : gestor.getProductos()) {
			if (productos instanceof Alimentacion) {
